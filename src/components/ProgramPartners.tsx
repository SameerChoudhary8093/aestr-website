...
const ProgramPartners = () => {
    ...
    return (
        <section className="relative py-32 bg-background-alt overflow-hidden">
            {/* Ambient Lighting */}
            <div className="absolute top-0 right-20 w-full max-w-[600px] aspect-square bg-accent/5 blur-[150px] rounded-full pointer-events-none z-0" />
            <div className="absolute bottom-20 left-10 w-full max-w-[500px] aspect-square bg-purple/10 blur-[150px] rounded-full pointer-events-none z-0" />
