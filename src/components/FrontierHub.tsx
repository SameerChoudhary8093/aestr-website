                                ...
                                <div className="lg:col-span-7 space-y-6">
                                    <div className="relative">
                                        <motion.h2 
                                            ...
                                            className="text-[26px] sm:text-[40px] md:text-[48px] font-orbitron font-black text-white leading-tight mb-8 relative z-10"
                                        >
                                            Aestr Is <br className="block sm:hidden" /> INDIA'S <br className="block sm:hidden" /> SOVEREIGN AI HUB
                                        </motion.h2>
                                    </div>
                            ...
                            <div className="bg-white/10 rounded-2xl p-6 md:p-8 border border-white/20 shadow-[0_0_30px_rgba(0,0,0,0.2)] mt-10 md:mt-12 w-full">
                                ...
                                <ul className="space-y-4 pl-2 mt-5 text-[14px] md:text-[15px] lg:text-[15.5px] w-full">
                                    <li className="flex items-start gap-3 md:gap-4 w-full">
                                        ...
                                        <span className="leading-snug text-white/90 w-full"><strong className="text-white">AESTR B.TECH (The 4-Year Residency):</strong> A hardcore undergraduate incubator forging the deep-tech scientists who will invent the intelligence of tomorrow.</span>
                                    </li>
                                    <li className="flex items-start gap-3 md:gap-4 w-full">
                                        <span className="text-[#D8F602] mt-1 text-[12px] tracking-widest shrink-0">■</span>
                        ...
                        <div className="bg-black px-5 py-2.5 md:px-7 md:py-3.5 rounded-2xl shadow-xl inline-flex items-center justify-center self-end md:self-auto border-2 border-white/20 lg:translate-x-4 shrink-0 w-fit">
                            <div className="w-auto h-12 md:h-18 lg:h-24 xl:h-28 relative">
                                <Image
                                    ...
                                    width={500}
                                    height={120}
                                    className="w-auto h-full object-contain brightness-[1.1]"
                                    priority
                                />
                            </div>
                        </div>
