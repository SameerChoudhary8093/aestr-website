                ...
                <div className="container-boxed relative z-10 flex flex-col items-center text-center space-y-0">
                    ...
                    <div className="flex flex-col lg:flex-row items-center justify-center gap-4 md:gap-8 text-foreground/60 text-sm mt-6 md:mt-8 border-t border-white/5 pt-5">
                        ...
                        <div className="flex items-center gap-4">
                            <a
                                href="https://www.facebook.com/profile.php?id=61575961450718"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="relative w-5 h-5 transition-all duration-300 hover:scale-110 hover:text-accent"
                            >
                            ...
                            <a
                                href="https://www.linkedin.com/company/aestr/posts/?feedView=all"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="relative w-5 h-5 transition-all duration-300 hover:scale-110 hover:text-accent"
                            >
                            ...
                            <a
                                href="https://www.instagram.com/aestr.gyanvihar/"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="relative w-5 h-5 transition-all duration-300 hover:scale-110 hover:text-accent"
                            >
