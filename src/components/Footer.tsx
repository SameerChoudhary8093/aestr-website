...
const Footer = () => {
    return (
        <footer className="w-full">
            ...
            <section className="bg-background text-white py-3 relative overflow-hidden border-t border-white/5">
                <div className="container-boxed relative z-10 flex flex-col items-center text-center space-y-0">
                    {/* Main Footer Content - Centered Single Line */}
                    <div className="w-full flex flex-wrap lg:flex-nowrap items-center justify-center gap-10 md:gap-12 lg:gap-16 text-sm px-4 md:px-8 bg-black/50 py-4 rounded-[1.5rem] border border-white/5">
                        {/* Unified Logo and Navigation Row - Centered */}
                        <div className="flex items-center justify-center gap-6 md:gap-8 lg:gap-10 shrink-0">
                            {/* SGVU Primary Logo */}
                            <div className="relative transition-all duration-500 hover:scale-110 flex items-center justify-center">
                                <Image
                                    ...
                                    width={160}
                                    height={40}
                                    className="w-auto h-10 md:h-12 lg:h-14 object-contain brightness-0 invert"
                                    priority
                                />
                            </div>
                            ...
                            <div className="flex items-center gap-6 md:gap-8">
                                ...
                                <div className="relative transition-all duration-500 hover:scale-110 flex items-center justify-center">
                                    <Image
                                        ...
                                        width={80}
                                        height={80}
                                        className="w-auto h-14 md:h-18 lg:h-24 object-contain"
                                    />
                                </div>
                            </div>
                        </div>

                        {/* Navigation Links in Single Line - No Wrapping */}
                        <div className="flex flex-nowrap items-center justify-center gap-2 md:gap-4 lg:gap-5 text-[9px] md:text-[10px] lg:text-xs font-orbitron font-medium tracking-[0.1em] text-white/60">
                            <a href="#" className="hover:text-accent transition-colors whitespace-nowrap">AESTR Home</a>
                            <a href="#" className="hover:text-accent transition-colors whitespace-nowrap">Terms of Use</a>
                            <a href="#" className="hover:text-accent transition-colors whitespace-nowrap">Map Directions</a>
                            <a href="#" className="hover:text-accent transition-colors whitespace-nowrap">Privacy</a>
                            <a href="#" className="hover:text-accent transition-colors whitespace-nowrap">Copyright</a>
                            <a href="#" className="hover:text-accent transition-colors whitespace-nowrap">Trademarks</a>
                            <a href="#" className="hover:text-accent transition-colors whitespace-nowrap">Contact Us</a>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col lg:flex-row items-center justify-center gap-4 text-foreground/60 text-sm mt-6 md:mt-8 border-t border-white/5 pt-5">
                        ...
                        <div className="flex items-center gap-2">
                            <a
                                ...
                                className="relative w-5 h-5 transition-all duration-300 hover:scale-110"
                            >
