...
const applications = [
    {
        ...
        desc: 'A Frontend Developer builds the visual and interactive parts of a website or app—the parts users see and use.',
    ...
    },
    {
        ...
        desc: "A Backend Developer works on the server-side of a website or app—the part users don't see. They make sure everything runs behind the scenes.",
    ...
    },
    {
        ...
        desc: 'A Full-Stack Developer is a professional who can work on both the frontend (client-side) and backend (server-side) of a web application.',
    ...
    },
    {
        ...
        desc: 'A Software Architect designs the high-level structure of software systems to ensure they are scalable, efficient, and maintainable.',
        ...
        <main className="bg-background min-h-screen text-foreground selection:bg-accent selection:text-black">
            ...
            <section className="py-24 bg-background relative overflow-hidden">
                <div className="container-boxed relative z-10">
                    <div className="space-y-16">
                        <div className="space-y-4">
                            <h2 className="text-h2 font-orbitron font-bold text-foreground tracking-tight">Curriculum</h2>
                        ...
                        <div className="space-y-12">
                            <h3 className="text-h2 font-orbitron font-bold text-foreground tracking-tight">
                                Programme <br />
            ...
            <section className="py-24 bg-background-alt">
                <div className="container-boxed">
                    <div className="space-y-16">
                        <div className="space-y-6">
                            <h2 className="text-h2 font-orbitron font-bold text-foreground">Innovation Labs</h2>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                            {[
                                { name: 'Augmented Human Lab', tag: "Specialized in UI/UX and Frontend", image: '/Other/lab-5.webp' },
                                { name: 'Soft "Brain" Lab', tag: 'Focus on Backend and AI Systems', image: '/Other/lab-4.webp' },
            ...
            <section className="py-24 bg-white relative overflow-hidden">
                <div className="container-boxed">
                    <motion.h2
                        ...
                        whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true }}
                        className="text-h2 font-orbitron font-bold text-black mb-16"
                    >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
                        {[
                            { num: "01", title: "AI-Powered DevOps & Automation", color: "bg-pink-50 border-pink-200" },
                            { num: "02", title: "Microservices & Cloud-Native Architectures", color: "bg-blue-50 border-blue-200 shadow-blue-100" },
                            { num: "03", title: "Site Reliability Engineering (SRE)", color: "bg-purple-50 border-purple-200" },
                            { num: "04", title: "Cyber-Physical System Design", color: "bg-pink-50 border-pink-200" },
                            { num: "05", title: "Full-Stack Observability & Analytics", color: "bg-purple-50 border-purple-300" }
                        ].map((trend, idx) => (
                            <motion.div
                                key={idx}
                                initial={{ opacity: 0, y: 30 }}
            ...
            <section className="py-24 bg-background-alt border-y border-white/5">
                <div className="container-boxed">
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-12 grayscale opacity-50">
                        <div className="h-10 flex items-center justify-center font-orbitron font-bold text-foreground/40 text-center">GOOGLE</div>
                        <div className="h-10 flex items-center justify-center font-orbitron font-bold text-foreground/40 text-center">AMAZON</div>
                        <div className="h-10 flex items-center justify-center font-orbitron font-bold text-foreground/40 text-center">NVIDIA</div>
                        <div className="h-10 flex items-center justify-center font-orbitron font-bold text-foreground/40 text-center">ACCENTURE</div>
                        <div className="h-10 flex items-center justify-center font-orbitron font-bold text-foreground/40 text-center">DELOITTE</div>
                        <div className="h-10 flex items-center justify-center font-orbitron font-bold text-foreground/40 text-center">SAMSUNG</div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-24 bg-white relative overflow-hidden text-black">
                <div className="container-boxed">
                    <motion.h2
                        ...
                        whileInView={{ opacity: 1, x: 0 }}
                        viewport={{ once: true }}
                        className="text-h2 font-orbitron font-bold text-black mb-6"
                    >
            ...
            {/* Future Scope Of Software Engineering (Image 5) */}
            <section className="py-24 bg-background relative overflow-hidden">
                <div className="container-boxed">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <motion.div
                        ...
                        >
                            <div className="space-y-4">
                                <h2 className="text-5xl md:text-6xl font-orbitron font-bold text-foreground leading-[1.1]">
                                    Future scope of <span className="text-foreground/60">software engineering</span>
                                </h2>
            ...
            <section className="py-24 bg-background-alt/30 border-t border-white/5">
                <div className="container-boxed">
                    <div className="space-y-16">
                        ...
                        >
                            Applications of <span className=" text-accent">Software Engineering</span>
                        </motion.h2>
                        ...
                        >
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-12 group">
                                ...
                                <div className="col-span-1 lg:col-span-2 p-8 lg:p-10 border-b lg:border-b-0 lg:border-r border-white/5 flex flex-col items-center justify-center text-center">
                                    <span className="lg:hidden text-purple font-orbitron text-xs uppercase tracking-widest mb-2 font-bold">Duration</span>
                                ...
                                <div className="col-span-1 lg:col-span-3 p-8 lg:p-10 border-b lg:border-b-0 lg:border-r border-white/5 flex flex-col items-center justify-center text-center">
                                    <span className="lg:hidden text-purple font-orbitron text-xs uppercase tracking-widest mb-2 font-bold">Annual Fee (INR)</span>
                                    <div className="space-y-1">
                                ...
                                <div className="col-span-1 lg:col-span-3 p-8 lg:p-10 flex flex-col justify-center">
                                    <span className="lg:hidden text-purple font-orbitron text-xs uppercase tracking-widest mb-4 font-bold text-center">Qualification</span>
                                    <div className="space-y-6 text-foreground/70 leading-relaxed font-medium">
                                        ...
                                        <p className="text-center lg:text-left">along with one of the following:</p>
                                        <div className="bg-purple/10 p-6 rounded-2xl border border-purple/20 text-center">
