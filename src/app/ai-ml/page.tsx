                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        >
                            <div className="aspect-[16/9] w-full">
                                <YouTubePlayer videoId="dQw4w9WgXcQ" title="AI & ML at AESTR" />
                            </div>
                        </motion.div>
                    </div>
                </div>
                ...
                <div className="container-boxed w-full max-w-[1224px] mx-auto relative z-10 text-center flex flex-col items-center">
                    <div className="max-w-6xl space-y-8">
                        <motion.h2 className="text-3xl md:text-5xl font-orbitron font-black text-white">
                            What is <span className="text-accent">AI & ML</span>?
                        </motion.h2>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
                                <div className="space-y-4">
                                    <p className="text-lg md:text-xl text-white/90 leading-[1.5] font-medium">
                                        Artificial Intelligence & Machine Learning is the systematic application of <strong className="text-accent font-orbitron font-bold">mathematics</strong>, <strong className="text-accent font-orbitron font-bold">statistics</strong>, and <strong className="text-accent font-orbitron font-bold">computer science</strong> to create intelligent systems that learn from data.
                                    </p>
                                </div>
                                <div className="space-y-4">
                                    <p className="text-lg md:text-xl text-white/90 leading-[1.5] font-medium">
                                        It encompasses deep learning architectures, reinforcement learning models, and the ethical frameworks needed to shape the future of autonomous systems and cognitive computing.
                                    </p>
                                </div>
                            </div>
                        </motion.div>
                ...
                <div className="container-boxed w-full max-w-[1224px] mx-auto relative z-10">
                    <div className="space-y-20">
                        <div className="text-center space-y-4">
                            ...
                            <p className="text-white/60 font-orbitron text-lg tracking-[0.2em] uppercase">Pathways for AI Specialists</p>
                        </div>

                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                            {[
                                { title: "ML Engineer", image: "/Other/_DSC0612.jpg", major: "Neural Networks", lab: "NVIDIA Pipeline" },
                                { title: "AI Researcher", image: "/Other/DSC01997.jpg", major: "Core Intelligence", lab: "Shodh AI Research" },
                                { title: "Vision Lead", image: "/Other/DSC08333.jpg.jpeg", major: "Visual Intelligence", lab: "Embodied Brain Lab" },
                                { title: "NLP Scientist", image: "/Other/image.jpeg", major: "Cognitive Systems", lab: "Policy Hub" }
                            ].map((app, idx) => (
                    ...
                    <div className="space-y-16">
                        ...
                        <div className="rounded-[3rem] shadow-[0_40px_100px_rgba(0,0,0,0.3)] border border-white/5 overflow-hidden" style={{backgroundColor: '#571AD0'}}>
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-12 group">
                                <div className="col-span-1 lg:col-span-4 p-8 lg:p-12 border-b lg:border-b-0 lg:border-r border-white/5 space-y-10">
                                    <div className="space-y-6">
                                        <p className="text-white/40 font-orbitron text-[10px] uppercase tracking-widest text-center lg:text-left">Major Specialization</p>
                                        <h4 className="text-2xl font-orbitron font-black text-white text-center lg:text-left">AI & <span className="text-accent">Machine Learning</span></h4>
                                    </div>
                                    <div className="space-y-6 pt-6 border-t border-white/5">
                                        <p className="text-white/40 font-orbitron text-[10px] uppercase tracking-widest text-center lg:text-left">Minor Specializations</p>
                                        <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            {["Robotics", "Data Engineering", "Cyber Security", "Cloud Computing", "Blockchain"].map((item) => (
                                                <li key={item} className="flex items-center justify-center lg:justify-start gap-3 text-white/70 text-sm font-medium">
                                ...
                                <div className="col-span-1 lg:col-span-2 p-8 lg:p-12 border-b lg:border-b-0 lg:border-r border-white/5 flex flex-col items-center justify-center text-center">
                                    <span className="lg:hidden text-accent font-orbitron text-xs uppercase tracking-widest mb-2">Duration</span>
                                    <div className="text-xl lg:text-base text-white">04</div>
                                ...
                                <div className="col-span-1 lg:col-span-3 p-8 lg:p-12 border-b lg:border-b-0 lg:border-r border-white/5 flex flex-col items-center justify-center text-center">
                                    <span className="lg:hidden text-accent font-orbitron text-xs uppercase tracking-widest mb-2">Annual Investment</span>
                                    <span className="text-accent font-black text-3xl lg:text-2xl">₹2.0L</span>
                                </div>
                                
                                <div className="col-span-1 lg:col-span-3 p-8 lg:p-12 flex flex-col items-center justify-center text-center">
                                    <span className="lg:hidden text-accent font-orbitron text-xs uppercase tracking-widest mb-2">Entry Threshold</span>
                                    <span className="text-lg lg:text-base text-white/90">70% Aggregate Minimum</span>
                                </div>
                            </div>
                        </div>
                    </div>
