            ...
            <section className="py-24 bg-background-alt/50 border-t border-white/5">
                <div className="container-boxed">
                    <div className="max-w-5xl space-y-12">
                        ...
                        >
                            What is <span className="decorative-serif text-accent">Artificial Intelligence?</span>
                        </motion.h2>
                        ...
                        >
                            <div className="space-y-4">
                                <h2 className="text-5xl md:text-6xl font-orbitron font-bold text-foreground leading-[1.1]">
                                    Future Scope Of <span className="decorative-serif text-foreground/60 italic">AI & ML</span>
                                </h2>
                ...
                <div className="container-boxed">
                    <div className="space-y-16">
                        <motion.h2 
                            ...
                            className="text-4xl md:text-5xl lg:text-6xl font-orbitron font-bold text-foreground"
                        >
                            Applications of <span className="decorative-serif text-accent">AI & ML</span>
                        </motion.h2>
