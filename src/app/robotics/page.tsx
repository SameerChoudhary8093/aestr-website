        ...
        semesters: [
            {
                ...
                subjects: [
                    ...
                    "Foundation of Robotics & Data Engineering",
                    "Robotics and Data Engineering Studio 1",
            ...
            },
            {
                ...
                subjects: [
                    ...
                    "Robotics Foundations: Statistics & Search Algorithms",
                    "Python for Robotics Programming Studio"
                ],
            },
        ],
    },
        ...
        semesters: [
            {
                ...
                subjects: [
                    ...
                    "Automation Foundations: Supervised Learning",
                    "Automation Studio -> Building Predictive Models",
                    "Data Structures and Algorithms Lab",
                    "Field Project/Field Visit-3 -> Innovation Lab Project I: Robotics System Design",
        ...
        semesters: [
            ...
            },
            {
                ...
                subjects: [
                    ...
                    "Innovation Lab Project IV: Robotics Product Realization",
        ...
        semesters: [
            {
                ...
                subjects: [
                    ...
                    "Robotics Ethics, Policy & Governance",
                    "Operating Systems",
                    "Computer Vision: Image Processing & Object Detection",
                    "Generative Robotics & LLM Architectures",
                    "Generative Robotics Studio -> Fine-tuning Foundational Models",
                    "Major Project Stage-I -> Innovation Lab Grand Challenge Seminar I (Robotics Major)"
                ],
            },
            {
                name: 'Semester 8',
                subjects: [
                    ...
                    "Seminar",
                    "Major Project-II -> Innovation Lab Grand Challenge Showcase (Robotics Major)",
                    "Real Time Robotics Systems",
                    "Distributed Robotics Systems",
                    "Compiler Construction",
                    "Robotics & Embodied Robotics Lab",
                    "Robotics in Edge Devices",
...
const RoboticsSpecializationPage = () => {
    ...
    return (
        <main className="bg-background min-h-screen text-foreground selection:bg-accent selection:text-black">
            ...
            <section className="py-24 bg-background-alt/50 border-t border-white/5">
                <div className="container-boxed">
                    <div className="max-w-5xl space-y-12">
                        ...
                        >
                            What is <span className=" text-accent">Robotics?</span>
                        </motion.h2>
                        ...
                        >
                            ...
                            <p className="text-xl md:text-2xl text-foreground/80 leading-relaxed font-medium">
                                <strong className="text-foreground">Robotics Engineering</strong> is the science of building intelligent systems that can learn from data, reason about complex problems, and act autonomously. From <span className="text-foreground font-bold">Large Language Models</span> that understand human speech to <span className="text-foreground font-bold">Autonomous Robotics</span> that navigate the physical world, Robotics is the engine of the next industrial revolution, redefining how we work, live, and create.
                            </p>
                        ...
                        >
                            <div className="space-y-6">
                                ...
                                <p className="text-xl md:text-2xl subheading-font text-black/70 leading-relaxed font-medium">
                                    The only engineering school where Robotics teaches you, and the future hires you.
                                </p>
                            </div>
                            ...
                            <div className="space-y-6 pt-4">
                                <div className="space-y-2">
                                    ...
                                    <p className="text-lg text-black/60 font-medium leading-relaxed max-w-xl">
                                        Taught by senior industry Engineers, offering hands-on real-world learning experiences in Automation and Robotics.
                                    </p>
                                </div>
                            </div>
                        </motion.div>
                    ...
                    <div className="space-y-16">
                        ...
                        <div className="flex flex-wrap gap-3 md:gap-4">
                            {[
                                ...
                                "3. Robotics & Embodied Robotics",
                                "4. Reinforcement Learning",
                                "5. Generative Robotics & LLMs",
                                "6. Robotics Ethics & Governance"
                            ].map((tag, i) => (
                                <motion.span 
                                    key={tag}
                ...
                <div className="container-boxed text-center space-y-16">
                    ...
                    <div className="relative pt-12 pb-20">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 pt-16">
                            {[
                                { title: "B.Tech Robotics With Shodh Robotics Track", sub: "35LPA+ jobs", color: "bg-[#FFC9E3] border-[#FF99C8]" },
                                ...
                                { title: "Nurturing Entrepreneurs", sub: "Silicon Valley of Robotics", color: "bg-[#FFC9FF] border-[#FF99FF]" }
                            ].map((item, idx) => (
                                <motion.div 
                                    key={idx}
                                    initial={{ opacity: 0, y: 20 }}
                    ...
                    <div className="space-y-16">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                            {[
                                ...
                                { name: 'RISC-V Lab', tag: "Design Custom Robotics Chips", image: '/Other/lab-3.webp' },
                                { name: 'Embodied Brain Lab', tag: 'Deploy Robotics Into Robots & ROS Systems', image: '/Other/lab-2.webp' }
                            ].map((lab, i) => (
                                <motion.div 
                                    key={lab.name}
                                    initial={{ opacity: 0, y: 30 }}
            ...
            <section className="py-24 bg-white relative overflow-hidden">
                <div className="container-boxed">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
                        {[
                            { num: "01", title: "Generative Robotics & Large Language Models", color: "bg-pink-50 border-pink-200" },
                            { num: "02", title: "Autonomous Robotics & Embodied Robotics", color: "bg-blue-50 border-blue-200 shadow-blue-100" },
                            ...
                            { num: "05", title: "Neural Hardware & Robotics Chip Design", color: "bg-purple-50 border-purple-300" }
                        ].map((trend, idx) => (
                            <motion.div
                                key={idx}
                                initial={{ opacity: 0, y: 30 }}
            ...
            {/* Future Scope Of Robotics-ML (Image 5) */}
            <section className="py-24 bg-background relative overflow-hidden">
                <div className="container-boxed">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <motion.div
                        ...
                        >
                            <div className="space-y-4">
                                <h2 className="text-h2 font-orbitron text-foreground leading-[1.1]">
                                    Future Scope Of <span className=" text-foreground/60 ">Robotics</span>
                                </h2>
                                <p className="text-lg text-foreground/70 leading-relaxed font-medium">
                                    Robotics Engineering is the science of building intelligent systems that can learn from data, reason about complex problems, and act autonomously.
                                </p>
                            </div>
                            ...
                            <div className="space-y-6">
                                ...
                                <ul className="space-y-4">
                                    {[
                                        "The Robotics market in India is projected to reach $7.8 billion by 2025.",
                                        "Companies are integrating GenRobotics into every layer of software development."
                                    ].map((item, i) => (
            ...
            <section className="py-24 bg-background-alt/30 border-t border-white/5">
                <div className="container-boxed">
                    <div className="space-y-16">
                        ...
                        >
                            Applications of <span className=" text-accent">Robotics</span>
                        </motion.h2>
                                        ...
                                        <td className="p-10 border-r border-white/5 align-top space-y-8">
                                            <div className="space-y-4">
                                                ...
                                                <ul className="grid grid-cols-1 gap-2">
                                                    {["Robotics Engineering", "Cloud Engineering", "Software Engineering", "Data Engineering", "Cyber Security"].map((item) => (
...
export default RoboticsSpecializationPage;
