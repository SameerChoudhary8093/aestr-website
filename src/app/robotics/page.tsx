                        ...
                        >
                            <div className="space-y-4">
                                ...
                                <h1 className="text-4xl md:text-5xl lg:text-7xl font-orbitron font-black text-white leading-tight">
                                    Robotics <span className="text-accent italic">& Automation</span>
                                </h1>
                            </div>
            ...
            <section className="py-12 relative overflow-hidden" style={{backgroundColor: '#571AD0'}}>
                <div className="container-boxed w-full max-w-[1224px] mx-auto relative z-10 text-center flex flex-col items-center">
                    <div className="max-w-6xl space-y-8">
                        ...
                        >
                            What is <span className="text-accent italic">Robotics & Automation</span>?
                        </motion.h2>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
                                <div className="space-y-4">
                                    <p className="text-lg md:text-xl text-white/90 leading-[1.5] font-medium">
                                        Robotics & Automation is the systematic application of <strong className="text-accent font-orbitron font-bold">mechanical engineering</strong>, <strong className="text-accent font-orbitron font-bold">computer science</strong>, and <strong className="text-accent font-orbitron font-bold">artificial intelligence</strong> to create intelligent machines that can interact with the physical world.
                                    </p>
                                </div>
                                <div className="space-y-4">
                                    <p className="text-lg md:text-xl text-white/90 leading-[1.5] font-medium">
                                        It encompasses robot design, control systems, computer vision, and machine learning techniques that enable autonomous systems to perceive, reason, and act in complex environments from manufacturing to healthcare.
                                    </p>
                                </div>
                            </div>
                        </motion.div>
                ...
                <div className="container-boxed w-full max-w-[1224px] mx-auto relative z-10">
                    <div className="space-y-20">
                        <div className="text-center space-y-4">
                            ...
                            <p className="text-white/60 font-orbitron text-lg tracking-[0.2em] uppercase">Applications of Robotics & Automation</p>
                        </div>
                            ...
                            {[
                                {
                                    ...
                                    desc: "Designing and developing autonomous robots for manufacturing, healthcare, and service industries.",
                                ...
                                },
                                {
                                    ...
                                    desc: "Creating intelligent automation systems for industrial processes and smart factories.",
                                ...
                                },
                                {
                                    ...
                                    desc: "Building perception systems that enable robots to see and understand their environment.",
                                    image: "/Other/DSC08333.jpg.jpeg",
                                    major: "Visual Perception",
                                    lab: "Apple Ecosystem"
                                },
                                {
                                    title: "Control Systems Engineer",
                                    desc: "Developing advanced control algorithms for precise robot movement and manipulation.",
                                        ...
                                        <td className="p-12 border-r border-white/5 align-top space-y-10">
                                            <div className="space-y-6">
                                                ...
                                                <div className="inline-block px-4 py-2 bg-accent/10 border border-accent/20 rounded-lg">
                                                    <span className="text-accent font-bold text-xs uppercase tracking-wider">Primary Track: Robotic Systems & Control</span>
                                                </div>
                                            </div>
                ...
                <div className="container-boxed relative z-10 w-full max-w-[1224px] mx-auto">
                    <div className="space-y-16">
                        <div className="space-y-4">
                            ...
                            <p className="text-black/40 font-orbitron text-xs uppercase tracking-[0.3em]">The Horizon of Robotics</p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-5 rounded-[2.5rem] overflow-hidden shadow-2xl border border-white/5" style={{backgroundColor: '#571AD0'}}>
                            {[
                                { id: "01", title: "Autonomous\nSystems" },
                                { id: "02", title: "Humanoid\nRobots" },
                                { id: "03", title: "Swarm\nIntelligence" },
                                { id: "04", title: "Soft\nRobotics" },
                                { id: "05", title: "Brain-\nMachine" }
                            ].map((item, index) => (
                        ...
                        >
                            <div className="space-y-4">
                                <h2 className="text-4xl md:text-6xl font-orbitron font-black text-white leading-tight">
                                    Future Scope of <br/>
                                    <span className="text-accent italic">Robotics & Automation</span>
                                </h2>
                                <p className="text-white/40 font-orbitron text-xs uppercase tracking-[0.3em]">Next-Gen Automation</p>
                            </div>

                            <div className="space-y-6 text-lg text-white/80 leading-relaxed font-medium">
                                <p>The robotics revolution represents the biggest transformation in industrial automation since the assembly line. As every sector adopts intelligent machines, the demand for robotics engineers is projected to grow by <span className="text-accent font-bold">35% YoY</span>.</p>
                                <p>Specializing in Robotics at AESTR equips you with cutting-edge skills in <span className="text-white font-bold">autonomous systems, computer vision, and control engineering</span> that power the next generation of intelligent machines.</p>
                            </div>
                        </motion.div>
