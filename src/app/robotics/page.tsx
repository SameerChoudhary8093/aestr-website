...
export default function RoboticsSpecializationPage() {
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        >
                            <div className="aspect-[16/9] w-full">
                                <YouTubePlayer videoId="dQw4w9WgXcQ" title="Robotics at AESTR" />
                            </div>
                        </motion.div>
                    </div>
                </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
                                <div className="space-y-4">
                                    <p className="text-lg md:text-xl text-white/90 leading-[1.5] font-medium">
                                        Robotics is the intersection of <strong className="text-accent font-orbitron font-bold">computer science</strong>, <strong className="text-accent font-orbitron font-bold">mechanical engineering</strong>, and <strong className="text-accent font-orbitron font-bold">electronics</strong> to build machines that can interact with the physical world.
                                    </p>
                                </div>
                                <div className="space-y-4">
                                    <p className="text-lg md:text-xl text-white/90 leading-[1.5] font-medium">
                                        It encompasses autonomous navigation, soft robotics, computer vision, and the development of intelligent agents that assist in everything from surgery to space exploration.
                                    </p>
                                </div>
                            </div>
                        </motion.div>
                    ...
                    <div className="space-y-16">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                ...
                                "2. Swarm & Collaborative Robotics",
                                "3. Computer Vision & SLAM",
                                "4. Industrial Automation & IIoT",
                                "5. Soft Robotics & Biomimicry",
                                "6. Haptics & Remote Operation"
                            ].map((tag, i) => (
                                <motion.span
                                    key={tag}
                ...
                <div className="container-boxed w-full max-w-[1224px] mx-auto relative z-10">
                    <div className="space-y-20">
                        <div className="text-center space-y-4">
                            ...
                            <p className="text-white/60 font-orbitron text-lg tracking-[0.2em] uppercase">Pathways for Robotics Engineers</p>
                        </div>

                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                            {[
                                { title: "Robotics Researcher", image: "/Other/_DSC0612.jpg", major: "Embodied AI", lab: "NVIDIA Pipeline" },
                                { title: "Automation Architect", image: "/Other/DSC01997.jpg", major: "IIoT Systems", lab: "Shodh AI Research" },
                                { title: "Vision Systems Eng.", image: "/Other/DSC08333.jpg.jpeg", major: "Visual Tracking", lab: "Embodied Brain Lab" },
                                { title: "UAV Specialist", image: "/Other/image.jpeg", major: "Swarms & UAVs", lab: "Policy Hub" }
                            ].map((app, idx) => (
                                    ...
                                    <tr className="group">
                                        <td className="p-12 border-r border-white/5 align-top space-y-10">
                                            <div className="space-y-6">
                                                ...
                                                <h4 className="text-2xl font-orbitron font-black text-white">Robotics & <span className="text-accent">Automation</span></h4>
                                            </div>
                                            <div className="space-y-6 pt-6 border-t border-white/5">
                                                <p className="text-white/40 font-orbitron text-[10px] uppercase tracking-widest">Minor Specializations</p>
                                                <ul className="grid grid-cols-2 gap-4">
                                                    {["Data Engineering", "Cloud", "Cyber Security", "AI", "Blockchain"].map((item) => (
