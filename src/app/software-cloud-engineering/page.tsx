...
const SoftwareCloudEngineeringSpecializationPage = () => {
                        ...
                        >
                            <div className="space-y-4">
                                ...
                                <h1 className="text-4xl md:text-5xl lg:text-7xl font-orbitron font-black text-white leading-tight">
                                    Software & <span className="text-accent italic">Cloud Engineering</span>
                                </h1>
                            </div>
            ...
            <section className="py-12 relative overflow-hidden" style={{backgroundColor: '#571AD0'}}>
                <div className="container-boxed w-full max-w-[1224px] mx-auto relative z-10 text-center flex flex-col items-center">
                    <div className="max-w-6xl space-y-8">
                        ...
                        >
                            What is <span className="text-accent italic">Software & Cloud Engineering</span>?
                        </motion.h2>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
                                <div className="space-y-4">
                                    <p className="text-lg md:text-xl text-white/90 leading-[1.5] font-medium">
                                        Software & Cloud Engineering is the systematic application of <strong className="text-accent font-orbitron font-bold">software architecture</strong>, <strong className="text-accent font-orbitron font-bold">cloud computing</strong>, and <strong className="text-accent font-orbitron font-bold">distributed systems</strong> to build scalable, resilient applications.
                                    </p>
                                </div>
                                <div className="space-y-4">
                                    <p className="text-lg md:text-xl text-white/90 leading-[1.5] font-medium">
                                        It encompasses cloud-native development, microservices architecture, DevOps practices, and modern software engineering methodologies that power today's digital enterprises and startups.
                                    </p>
                                </div>
                            </div>
                        </motion.div>
                ...
                <div className="container-boxed w-full max-w-[1224px] mx-auto relative z-10">
                    <div className="space-y-20">
                        <div className="text-center space-y-4">
                            ...
                            <p className="text-white/60 font-orbitron text-lg tracking-[0.2em] uppercase">Applications of Software & Cloud Engineering</p>
                        </div>
                            ...
                            {[
                                {
                                    ...
                                    desc: "Designing scalable cloud infrastructure and architecture for enterprise-level applications and services.",
                                ...
                                },
                                {
                                    ...
                                    desc: "Building and maintaining CI/CD pipelines and deployment automation for modern software development.",
                                    image: "/Other/DSC01997.jpg",
                                    major: "DevOps Systems",
                                    lab: "Apple Ecosystem"
                                },
                                {
                                    title: "Full Stack Developer",
                                    desc: "Creating end-to-end web and mobile applications using modern frameworks and cloud services.",
                                ...
                                },
                                {
                                    ...
                                    desc: "Architecting comprehensive software solutions that integrate multiple cloud services and technologies.",
                                    image: "/Other/image.jpeg",
                                    major: "Solution Design",
                                        ...
                                        <td className="p-12 border-r border-white/5 align-top space-y-10">
                                            <div className="space-y-6">
                                                ...
                                                <h4 className="text-2xl font-orbitron font-black text-white leading-tight">
                                                    Software & <br/>
                                                    <span className="text-accent italic">Cloud Engineering</span>
                                                </h4>
                                                <div className="inline-block px-4 py-2 bg-accent/10 border border-accent/20 rounded-lg">
                                                    <span className="text-accent font-bold text-xs uppercase tracking-wider">Primary Track: Cloud Architecture & DevOps</span>
                                                </div>
                                            </div>
                ...
                <div className="container-boxed relative z-10 w-full max-w-[1224px] mx-auto">
                    <div className="space-y-16">
                        <div className="space-y-4">
                            ...
                            <p className="text-black/40 font-orbitron text-xs uppercase tracking-[0.3em]">The Horizon of Cloud Computing</p>
                        </div>
                        ...
                        >
                            <div className="space-y-4">
                                <h2 className="text-4xl md:text-6xl font-orbitron font-black text-white leading-tight">
                                    Future Scope of <br/>
                                    <span className="text-accent italic">Software & Cloud Engineering</span>
                                </h2>
                                <p className="text-white/40 font-orbitron text-xs uppercase tracking-[0.3em]">Next-Gen Cloud</p>
                            </div>

                            <div className="space-y-6 text-lg text-white/80 leading-relaxed font-medium">
                                <p>The cloud computing revolution represents the biggest transformation in software development since the internet. As every business migrates to the cloud, the demand for cloud engineers is projected to grow by <span className="text-accent font-bold">42% YoY</span>.</p>
                                <p>Specializing in Software & Cloud Engineering at AESTR equips you with cutting-edge skills in <span className="text-white font-bold">cloud architecture, DevOps automation, and distributed systems</span> that power the world's most innovative digital platforms.</p>
                            </div>
                        </motion.div>
...
export default SoftwareCloudEngineeringSpecializationPage;
