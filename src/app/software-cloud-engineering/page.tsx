...
export default function SoftwareCloudSpecializationPage() {
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        >
                            <div className="space-y-4">
                                ...
                                <h1 className="text-4xl md:text-5xl lg:text-7xl font-orbitron font-black text-white leading-tight">
                                    Software & <span className="text-accent">Cloud Engineering</span>
                                </h1>
                            </div>
                        ...
                        >
                            <div className="aspect-[16/9] w-full">
                                <YouTubePlayer videoId="w7ejDZ8SWv8" title="Software Engineering at AESTR" />
                            </div>
                        </motion.div>
                    </div>
                </div>
                ...
                <div className="container-boxed w-full max-w-[1224px] mx-auto relative z-10 text-center flex flex-col items-center">
                    <div className="max-w-6xl space-y-8">
                        <motion.h2 className="text-3xl md:text-5xl font-orbitron font-black text-white">
                            What is <span className="text-accent">Software & Cloud</span>?
                        </motion.h2>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
                                <div className="space-y-4">
                                    <p className="text-lg md:text-xl text-white/90 leading-[1.5] font-medium">
                                        Software & Cloud Engineering is the discipline of <strong className="text-accent font-orbitron font-bold">architecting</strong>, <strong className="text-accent font-orbitron font-bold">deploying</strong>, and <strong className="text-accent font-orbitron font-bold">scaling</strong> complex applications in distributed environments.
                                    </p>
                                </div>
                                <div className="space-y-4">
                                    <p className="text-lg md:text-xl text-white/90 leading-[1.5] font-medium">
                                        It encompasses microservices, serverless computing, DevSecOps pipelines, and the management of global cloud infrastructure that supports billions of users.
                                    </p>
                                </div>
                            </div>
                        </motion.div>
                ...
                <div className="container-boxed w-full max-w-[1224px] mx-auto relative z-10">
                    <div className="space-y-20">
                        <div className="text-center space-y-4">
                            ...
                            <p className="text-white/60 font-orbitron text-lg tracking-[0.2em] uppercase">Pathways for Software Engineers</p>
                        </div>

                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                            {[
                                { title: "Cloud Architect", image: "/Other/_DSC0612.jpg", major: "Cloud Systems", lab: "NVIDIA Pipeline" },
                                { title: "SRE Lead", image: "/Other/DSC01997.jpg", major: "Site Reliability", lab: "Shodh AI Research" },
                                { title: "Full Stack Eng.", image: "/Other/DSC08333.jpg.jpeg", major: "Enterprise Apps", lab: "Embodied Brain Lab" },
                                { title: "DevSecOps Eng.", image: "/Other/image.jpeg", major: "Security Ops", lab: "Policy Hub" }
                            ].map((app, idx) => (
                                    ...
                                    <tr className="group">
                                        <td className="p-12 border-r border-white/5 align-top space-y-10">
                                            <div className="space-y-6">
                                                ...
                                                <h4 className="text-2xl font-orbitron font-black text-white">Software & <span className="text-accent">Cloud Engineering</span></h4>
                                            </div>
                                            <div className="space-y-6 pt-6 border-t border-white/5">
                                                <p className="text-white/40 font-orbitron text-[10px] uppercase tracking-widest">Minor Specializations</p>
                                                <ul className="grid grid-cols-2 gap-4">
                                                    {["Robotics", "Data Engineering", "Cyber Security", "AI", "Blockchain"].map((item) => (
