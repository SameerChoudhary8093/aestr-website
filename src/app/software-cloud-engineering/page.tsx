        ...
        semesters: [
            {
                ...
                subjects: [
                    ...
                    "Foundation of Cloud Computing & Data Engineering",
                    "Cloud Computing and Data Engineering Studio 1",
            ...
            },
            {
                ...
                subjects: [
                    ...
                    "Software & Cloud Engineering Foundations: Statistics & Search Algorithms",
                    "Python for Cloud Computing Programming Studio"
                ],
            },
        ],
    },
        ...
        semesters: [
            {
                ...
                subjects: [
                    ...
                    "Cloud Computing Foundations: Supervised Learning",
                    "Cloud Computing Studio -> Building Predictive Models",
                    "Data Structures and Algorithms Lab",
                    "Field Project/Field Visit-3 -> Innovation Lab Project I: Cloud Computing System Design",
        ...
        semesters: [
            {
                ...
                subjects: [
                    ...
                    "Computer Architectures for Cloud Computing",
                    "Natural Language Processing: Text Analytics & Modeling",
                    "NLP Studio -> Building Chatbots & Language Models",
                    "Innovation Lab Project III: Real-world Cloud Computing Deployment",
            ...
            },
            {
                ...
                subjects: [
                    ...
                    "Innovation Lab Project IV: Cloud Computing Product Realization",
        ...
        semesters: [
            {
                ...
                subjects: [
                    ...
                    "Cloud Computing Ethics, Policy & Governance",
                    "Operating Systems",
                    "Computer Vision: Image Processing & Object Detection",
                    "Generative Cloud Computing & LLM Architectures",
                    "Generative Cloud Computing Studio -> Fine-tuning Foundational Models",
                    "Major Project Stage-I -> Innovation Lab Grand Challenge Seminar I (Cloud Computing Major)"
                ],
            },
            {
                name: 'Semester 8',
                subjects: [
                    ...
                    "Seminar",
                    "Major Project-II -> Innovation Lab Grand Challenge Showcase (Cloud Computing Major)",
                    "Real Time Cloud Computing Systems",
                    "Distributed Cloud Computing Systems",
                    "Compiler Construction",
                    "Robotics & Embodied Cloud Computing Lab",
                    "Cloud Computing in Edge Devices",
...
const SoftwareCloudSpecializationPage = () => {
    ...
    return (
        <main className="bg-background min-h-screen text-foreground selection:bg-accent selection:text-black">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            <div className="space-y-6">
                                ...
                                <h1 className="text-hero font-orbitron text-foreground tracking-tight">
                                    Software & <br />
                                    <span className="text-accent">Cloud Engineering</span>
                                </h1>
                            </div>
                        ...
                        >
                            <div className="aspect-[4/3] w-full rounded-2xl overflow-hidden border border-white/10 shadow-3xl bg-background-alt group">
                                <YouTubePlayer 
                                    videoId="mA3Z2VYMNXo" 
                                    title="Software & Cloud Engineering overview"
                                />
                            </div>
            ...
            <section className="py-24 bg-background-alt/50 border-t border-white/5">
                <div className="container-boxed">
                    <div className="max-w-5xl space-y-12">
                        ...
                        >
                            What is <span className=" text-accent">Software & Cloud Engineering?</span>
                        </motion.h2>
                        ...
                        >
                            ...
                            <p className="text-xl md:text-2xl text-foreground/80 leading-relaxed font-medium">
                                <strong className="text-foreground">Software & Cloud Engineering</strong> is the science of building intelligent systems that can learn from data, reason about complex problems, and act autonomously. From <span className="text-foreground font-bold">Large Language Models</span> that understand human speech to <span className="text-foreground font-bold">Autonomous Robotics</span> that navigate the physical world, Cloud Computing is the engine of the next industrial revolution, redefining how we work, live, and create.
                            </p>
                        ...
                        >
                            <div className="space-y-6">
                                ...
                                <p className="text-xl md:text-2xl subheading-font text-black/70 leading-relaxed font-medium">
                                    The only engineering school where Cloud Computing teaches you, and the future hires you.
                                </p>
                            </div>
                            ...
                            <div className="space-y-6 pt-4">
                                <div className="space-y-2">
                                    ...
                                    <p className="text-lg text-black/60 font-medium leading-relaxed max-w-xl">
                                        Taught by senior industry Engineers, offering hands-on real-world learning experiences in Cloud Computing and Cloud Computing.
                                    </p>
                                </div>
                            </div>
                        </motion.div>
                    ...
                    <div className="space-y-16">
                        ...
                        <div className="flex flex-wrap gap-3 md:gap-4">
                            {[
                                ...
                                "3. Robotics & Embodied Cloud Computing",
                                "4. Reinforcement Learning",
                                "5. Generative Cloud Computing & LLMs",
                                "6. Cloud Computing Ethics & Governance"
                            ].map((tag, i) => (
                                <motion.span 
                                    key={tag}
                ...
                <div className="container-boxed text-center space-y-16">
                    ...
                    <div className="relative pt-12 pb-20">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 pt-16">
                            {[
                                { title: "B.Tech Cloud Computing With Shodh Cloud Computing Track", sub: "35LPA+ jobs", color: "bg-[#FFC9E3] border-[#FF99C8]" },
                                ...
                                { title: "Nurturing Entrepreneurs", sub: "Silicon Valley of Cloud Computing", color: "bg-[#FFC9FF] border-[#FF99FF]" }
                            ].map((item, idx) => (
                                <motion.div 
                                    key={idx}
                                    initial={{ opacity: 0, y: 20 }}
                    ...
                    <div className="space-y-16">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                            {[
                                ...
                                { name: 'RISC-V Lab', tag: "Design Custom Cloud Computing Chips", image: '/Other/lab-3.webp' },
                                { name: 'Embodied Brain Lab', tag: 'Deploy Cloud Computing Into Robots & ROS Systems', image: '/Other/lab-2.webp' }
                            ].map((lab, i) => (
                                <motion.div 
                                    key={lab.name}
                                    initial={{ opacity: 0, y: 30 }}
            ...
            <section className="py-24 bg-white relative overflow-hidden">
                <div className="container-boxed">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
                        {[
                            { num: "01", title: "Generative Cloud Computing & Large Language Models", color: "bg-pink-50 border-pink-200" },
                            { num: "02", title: "Autonomous Robotics & Embodied Cloud Computing", color: "bg-blue-50 border-blue-200 shadow-blue-100" },
                            ...
                            { num: "05", title: "Neural Hardware & Cloud Computing Chip Design", color: "bg-purple-50 border-purple-300" }
                        ].map((trend, idx) => (
                            <motion.div
                                key={idx}
                                initial={{ opacity: 0, y: 30 }}
            ...
            {/* Future Scope Of Cloud Computing-ML (Image 5) */}
            <section className="py-24 bg-background relative overflow-hidden">
                <div className="container-boxed">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <motion.div
                        ...
                        >
                            <div className="space-y-4">
                                <h2 className="text-h2 font-orbitron text-foreground leading-[1.1]">
                                    Future Scope Of <span className=" text-foreground/60 ">Software & Cloud Engineering</span>
                                </h2>
                                <p className="text-lg text-foreground/70 leading-relaxed font-medium">
                                    Software & Cloud Engineering is the science of building intelligent systems that can learn from data, reason about complex problems, and act autonomously.
                                </p>
                            </div>
                            ...
                            <div className="space-y-6">
                                ...
                                <ul className="space-y-4">
                                    {[
                                        "The Cloud Computing market in India is projected to reach $7.8 billion by 2025.",
                                        "Companies are integrating GenCloud Computing into every layer of software development."
                                    ].map((item, i) => (
                        ...
                        >
                            ...
                            <div className="relative aspect-square w-full max-w-[600px] ml-auto">
                                <Image 
                                    ...
                                    alt="Future Cloud Computing Robotics" 
                                    fill 
            ...
            <section className="py-24 bg-background-alt/30 border-t border-white/5">
                <div className="container-boxed">
                    <div className="space-y-16">
                        ...
                        >
                            Applications of <span className=" text-accent">Software & Cloud Engineering</span>
                        </motion.h2>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            {[
                                ...
                                },
                                {
                                    ...
                                    major: "Software & Cloud Engineering",
                                    lab: "Shodh Cloud Computing Research"
                                }
                            ].map((app, idx) => (
                                <motion.div
                                    key={idx}
                                        ...
                                        <td className="p-10 border-r border-white/5 align-top space-y-8">
                                            <div className="space-y-4">
                                                ...
                                                <ul className="grid grid-cols-1 gap-2">
                                                    {["Software & Cloud Engineering", "Cloud Engineering", "Software Engineering", "Data Engineering", "Cyber Security"].map((item) => (
...
export default SoftwareCloudSpecializationPage;
