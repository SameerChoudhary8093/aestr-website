...
const CyberSecuritySpecializationPage = () => {
            ...
            <section className="py-12 relative overflow-hidden" style={{backgroundColor: '#571AD0'}}>
                <div className="container-boxed w-full max-w-[1224px] mx-auto relative z-10 text-center flex flex-col items-center">
                    <div className="max-w-6xl space-y-8">
                        ...
                        >
                            What is <span className="text-accent italic">Cyber Security</span>?
                        </motion.h2>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
                                <div className="space-y-4">
                                    <p className="text-lg md:text-xl text-white/90 leading-[1.5] font-medium">
                                        Cyber Security is the systematic application of <strong className="text-accent font-orbitron font-bold">information security</strong>, <strong className="text-accent font-orbitron font-bold">network defense</strong>, and <strong className="text-accent font-orbitron font-bold">ethical hacking</strong> to protect digital assets and infrastructure.
                                    </p>
                                </div>
                                <div className="space-y-4">
                                    <p className="text-lg md:text-xl text-white/90 leading-[1.5] font-medium">
                                        It encompasses threat detection, vulnerability assessment, incident response, and security architecture that safeguard organizations from cyber threats and ensure data integrity.
                                    </p>
                                </div>
                            </div>
                        </motion.div>
                ...
                <div className="container-boxed w-full max-w-[1224px] mx-auto relative z-10">
                    <div className="space-y-20">
                        <div className="text-center space-y-4">
                            ...
                            <p className="text-white/60 font-orbitron text-lg tracking-[0.2em] uppercase">Applications of Cyber Security</p>
                        </div>
                            ...
                            {[
                                {
                                    ...
                                    desc: "Monitoring and analyzing security threats to protect organizational networks and systems from cyber attacks.",
                                ...
                                },
                                {
                                    ...
                                    desc: "Conducting ethical hacking assessments to identify vulnerabilities and strengthen security defenses.",
                                ...
                                },
                                {
                                    ...
                                    desc: "Designing comprehensive security frameworks and architectures for enterprise-level protection.",
                                ...
                                },
                                {
                                    ...
                                    desc: "Leading rapid response teams to mitigate security breaches and recover from cyber incidents.",
                                        ...
                                        <td className="p-12 border-r border-white/5 align-top space-y-10">
                                            <div className="space-y-6">
                                                ...
                                                <h4 className="text-2xl font-orbitron font-black text-white leading-tight">
                                                    Cyber <br/>
                                                    <span className="text-accent italic">Security</span>
                                                </h4>
                                                <div className="inline-block px-4 py-2 bg-accent/10 border border-accent/20 rounded-lg">
                                                    <span className="text-accent font-bold text-xs uppercase tracking-wider">Primary Track: Information Security & Defense</span>
                                                </div>
                                            </div>
                ...
                <div className="container-boxed relative z-10 w-full max-w-[1224px] mx-auto">
                    <div className="space-y-16">
                        <div className="space-y-4">
                            ...
                            <p className="text-black/40 font-orbitron text-xs uppercase tracking-[0.3em]">The Horizon of Cyber Security</p>
                        </div>
                        ...
                        >
                            <div className="space-y-4">
                                <h2 className="text-4xl md:text-6xl font-orbitron font-black text-white leading-tight">
                                    Future Scope of <br/>
                                    <span className="text-accent italic">Cyber Security</span>
                                </h2>
                                <p className="text-white/40 font-orbitron text-xs uppercase tracking-[0.3em]">Next-Gen Defense</p>
                            </div>

                            <div className="space-y-6 text-lg text-white/80 leading-relaxed font-medium">
                                <p>The cyber security landscape represents the most critical frontier in digital protection today. As every organization faces sophisticated threats, the demand for security professionals is projected to grow by <span className="text-accent font-bold">38% YoY</span>.</p>
                                <p>Specializing in Cyber Security at AESTR equips you with cutting-edge skills in <span className="text-white font-bold">threat intelligence, security architecture, and incident response</span> that protect the world's most valuable digital assets.</p>
                            </div>
                        </motion.div>
...
export default CyberSecuritySpecializationPage;
