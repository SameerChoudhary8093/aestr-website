            ...
            <section className="py-24 bg-background relative overflow-hidden">
                <div className="container-boxed">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            <div className="space-y-4">
                                <h2 className="text-h2 font-orbitron font-bold text-foreground leading-[1.1]">
                                    Future Scope Of <span className=" text-foreground/60 ">Cyber Security</span>
                                </h2>
                ...
                <div className="container-boxed">
                    <div className="space-y-16">
                        <motion.h2 
                            ...
                            whileInView={{ opacity: 1, y: 0 }}
                            viewport={{ once: true }}
                            className="text-h2 font-orbitron font-bold text-foreground"
                        >
                            Applications of <span className=" text-accent">Cyber Security</span>
                        </motion.h2>
