                ...
                <div className="max-w-[1400px] mx-auto w-full">
                    <div className="flex flex-col lg:flex-row justify-between items-center gap-12 mb-16">
                        ...
                        <div className="w-full lg:w-1/2 relative aspect-[4/3] lg:aspect-video bg-white/5 border border-white/10 rounded-2xl flex items-center justify-center shadow-2xl overflow-hidden group">
                            <img src="/saleforce-training/Image-1.png" alt="Salesforce Developer Training Hero" className="absolute inset-0 w-full h-full object-cover object-center group-hover:scale-105 transition-transform duration-700 ease-out" />
                        </div>
                    </div>
                ...
                <div className="max-w-[1400px] mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="w-full aspect-[16/9] bg-white/10 rounded-md relative overflow-hidden flex items-center justify-center shadow-md group">
                            <img src="/saleforce-training/Image-2.png" alt="Laptop Screen Focus" className="absolute inset-0 w-full h-full object-cover object-center group-hover:scale-105 transition-transform duration-700 ease-out" />
                        </div>
                        {/* Bottom Two Images */}
                        <div className="grid grid-cols-2 gap-4">
                            <div className="w-full aspect-[4/3] bg-white/10 rounded-md relative overflow-hidden hidden lg:flex items-center justify-center shadow-md group">
                                <img src="/saleforce-training/Image-3.png" alt="Classroom Presentation" className="absolute inset-0 w-full h-full object-cover object-center group-hover:scale-105 transition-transform duration-700 ease-out" />
                            </div>
                            <div className="w-full aspect-[4/3] bg-white/10 rounded-md relative overflow-hidden flex items-center justify-center shadow-md group">
                                <img src="/saleforce-training/Image-4.png" alt="Student Group Photo" className="absolute inset-0 w-full h-full object-cover object-center group-hover:scale-105 transition-transform duration-700 ease-out" />
                            </div>
                        </div>
                    </div>
                ...
                <div className="max-w-[1400px] mx-auto w-full">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
                        ...
                        <a href="/salesforce-training/technical-training" className="group bg-black rounded-3xl p-6 lg:p-8 flex flex-col justify-between hover:shadow-[0_20px_40px_rgba(0,0,0,0.5)] hover:-translate-y-3 hover:scale-[1.02] transform transition-all duration-500 ease-out cursor-pointer relative overflow-hidden">
                            ...
                            <div className="w-full aspect-video bg-white/5 rounded-2xl mb-8 flex items-center justify-center overflow-hidden border border-white/5 group-hover:border-accent/30 transition-colors duration-500 relative z-10">
                                ...
                                <img src="/saleforce-training/Image-5.png" alt="Technical Training" className="w-full h-full object-cover object-center opacity-80 group-hover:opacity-100 group-hover:scale-110 transition-all duration-700" />
                            </div>
                        ...
                        <a href="/salesforce-training/soft-skills" className="group bg-black rounded-3xl p-6 lg:p-8 flex flex-col justify-between hover:shadow-[0_20px_40px_rgba(0,0,0,0.5)] hover:-translate-y-3 hover:scale-[1.02] transform transition-all duration-500 ease-out cursor-pointer relative overflow-hidden">
                            ...
                            <div className="w-full aspect-video bg-white/5 rounded-2xl mb-8 flex items-center justify-center overflow-hidden border border-white/5 group-hover:border-accent/30 transition-colors duration-500 relative z-10">
                                <div className="absolute inset-0 bg-accent/20 scale-0 group-hover:scale-100 transition-transform duration-700 ease-out rounded-full blur-3xl z-10 pointer-events-none" />
                                <img src="/saleforce-training/Image-6.png" alt="Soft Skill" className="w-full h-full object-cover object-center opacity-80 group-hover:opacity-100 group-hover:scale-110 transition-all duration-700" />
                            </div>
                            <div className="relative z-10 flex flex-col gap-4">
                                <div>
                        ...
                        <a href="/salesforce-training/placement-support" className="group bg-black rounded-3xl p-6 lg:p-8 flex flex-col justify-between hover:shadow-[0_20px_40px_rgba(0,0,0,0.5)] hover:-translate-y-3 hover:scale-[1.02] transform transition-all duration-500 ease-out cursor-pointer relative overflow-hidden">
                            ...
                            <div className="w-full aspect-video bg-white/5 rounded-2xl mb-8 flex items-center justify-center overflow-hidden border border-white/5 group-hover:border-accent/30 transition-colors duration-500 relative z-10">
                                <div className="absolute inset-0 bg-accent/20 scale-0 group-hover:scale-100 transition-transform duration-700 ease-out rounded-full blur-3xl z-10 pointer-events-none" />
                                <img src="/saleforce-training/Image-7.png" alt="Placement Training" className="w-full h-full object-cover object-center opacity-80 group-hover:opacity-100 group-hover:scale-110 transition-all duration-700" />
                            </div>
                            <div className="relative z-10 flex flex-col gap-4">
                                <div>
                        ...
                        <a href="/salesforce-training/test-results" className="group bg-black rounded-3xl p-6 lg:p-8 flex flex-col justify-between hover:shadow-[0_20px_40px_rgba(0,0,0,0.5)] hover:-translate-y-3 hover:scale-[1.02] transform transition-all duration-500 ease-out cursor-pointer relative overflow-hidden">
                            ...
                            <div className="w-full aspect-video bg-white/5 rounded-2xl mb-8 flex items-center justify-center overflow-hidden border border-white/5 group-hover:border-accent/30 transition-colors duration-500 relative z-10">
                                <div className="absolute inset-0 bg-accent/20 scale-0 group-hover:scale-100 transition-transform duration-700 ease-out rounded-full blur-3xl z-10 pointer-events-none" />
                                <img src="/saleforce-training/Image-8.png" alt="Test Result" className="w-full h-full object-cover object-center opacity-80 group-hover:opacity-100 group-hover:scale-110 transition-all duration-700" />
                            </div>
                            <div className="relative z-10 flex flex-col gap-4">
                                <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
                        ...
                        <div className="border border-white/10 p-8 lg:p-14 transition-colors bg-purple group">
                            ...
                            <ul className="space-y-0">
                                {["Data Modeling", "Security & Access Control", "Process Automation (Flows)", "Reports & Dashboards"].map(item => (
                                    <li key={item} className="flex justify-between items-center border-b border-white/20 py-5 lg:py-6 last:border-0 last:pb-0 uppercase text-[10px] md:text-sm font-bold tracking-widest text-white/80 group-hover:text-white transition-colors">
                                        <span>{item}</span>
                        ...
                        <div className="border border-white/10 p-8 lg:p-14 transition-colors bg-purple group">
                            ...
                            <ul className="space-y-0">
                                {["Apex Programming (SOQL)", "Apex Triggers & Testing", "Lightning Web Components (LWC)", "Integration (REST/SOAP)"].map(item => (
                                    <li key={item} className="flex justify-between items-center border-b border-white/20 py-5 lg:py-6 last:border-0 last:pb-0 uppercase text-[10px] md:text-sm font-bold tracking-widest text-white/80 group-hover:text-white transition-colors">
                                        <span>{item}</span>
                                        <span className="text-accent font-orbitron opacity-100 flex items-center justify-center shrink-0 w-5 h-5 border border-accent rounded-sm text-[10px] bg-black/20">✔</span>
                                    </li>
            ...
            <section className="bg-accent text-black py-24 px-6 md:px-12 lg:px-24">
                <div className="max-w-[1400px] mx-auto w-full">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-6 h-full items-stretch">
                        <div className="border-[3px] border-black bg-black p-8 lg:p-12 flex flex-col min-h-[350px] shadow-[8px_8px_0px_#222] hover:-translate-y-2 transition-transform">
                            <h3 className="font-orbitron font-black text-2xl lg:text-3xl uppercase leading-tight lg:leading-[1.1] mb-auto text-white">Articulation <br/> & Presence</h3>
                        ...
                        <div className="border-[3px] border-black bg-black p-8 lg:p-12 flex flex-col min-h-[350px] shadow-[8px_8px_0px_#222] hover:-translate-y-2 transition-transform">
                            <h3 className="font-orbitron font-black text-2xl lg:text-3xl uppercase leading-tight lg:leading-[1.1] mb-auto text-accent">Corporate <br/> Strategy</h3>
                        ...
                        <div className="border-[3px] border-black bg-black p-8 lg:p-12 flex flex-col min-h-[350px] shadow-[8px_8px_0px_#222] hover:-translate-y-2 transition-transform">
                            <h3 className="font-orbitron font-black text-2xl lg:text-3xl uppercase leading-tight lg:leading-[1.1] mb-auto text-white">Behavioral <br/> Psychology</h3>
